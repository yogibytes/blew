...
export default function RegisterPage() {
  ...
  const createAccount = async () => {
    ...
    try {
      ...
      // console.log("type of the apiKey is: " + typeof (apiKey)); 
      // console.log(" apiKey before stringify is: "+ apiKey); 
      // const blewApi = JSON.stringify(apiKey);
      // console.log("type of the apiKey is: " + typeof (blewApi)); 
      // console.log(" apiKey after stringify is: "+ blewApi); 
      if (data?.data?.apiKey) {
        localStorage.setItem('blew-api-key', data.data.apiKey )
        setApiKey(data.data.apiKey)
        saveMerchantApiKey(data.data.apiKey)
        setMerchant({
          id: data.data.id,
